...
class ReadSplunk extends AdapterRead {
    ...
    read(from, to, limit, state) {
        ...
        var query = this.queryBuilder.compile(this.filter, { fields: this.fields, optimizations: this.optimizations });
        ...
        .then(function() {
            ...
            throw self.runtimeError('INTERNAL-ERROR', { error: e.error });
